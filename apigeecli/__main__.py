...
def main():
    ...
    delete_keyvaluemap_entry_in_an_environment = parser_keyvaluemaps.add_parser('delete-keyvaluemap-entry-in-an-environment', parents=[parent_parser, environment_parser],
    ...
    get_a_keys_value_in_an_environment_scoped_keyvaluemap = parser_keyvaluemaps.add_parser('get-a-keys-value-in-an-environment-scoped-keyvaluemap', parents=[parent_parser, environment_parser],
    ...
    update_keyvaluemap_in_an_environment = parser_keyvaluemaps.add_parser('update-keyvaluemap-in-an-environment', parents=[parent_parser, environment_parser],
