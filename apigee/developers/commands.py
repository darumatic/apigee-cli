...
@click.option(
    '--startkey', default="", show_default=True, help='To filter the keys that are returned, enter the email of a developer that the list will start with.'
)
...
@common_silent_options
@click.option('-n', '--name', help="The developer's email. This value is used to uniquely identify the developer in Apigee Edge.", required=True)
@click.option('--action', type=click.Choice(['active', 'inactive'], case_sensitive=False), required=True, show_default=True)
