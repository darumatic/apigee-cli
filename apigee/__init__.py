...
APIGEE_CLI_LAST_ERROR_LOG_FILE = str(Path(APIGEE_CLI_DIRECTORY) / 'last_error.log')
APIGEE_CLI_PREFIX = getenv('APIGEE_CLI_PREFIX')
APIGEE_CLI_SUPPRESS_RETRY_MESSAGE = getenv('APIGEE_CLI_SUPPRESS_RETRY_MESSAGE') or True
APIGEE_CLI_SUPPRESS_RETRY_RESPONSE = getenv('APIGEE_CLI_SUPPRESS_RETRY_RESPONSE') or True
