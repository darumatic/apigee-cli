...
def _create_permissions(username, password, mfa_secret, org, profile, name, body, **kwargs):
    return Permissions(gen_auth(username, password, mfa_secret), org, name) \
...
def _team_permissions(
    username, password, mfa_secret, org, profile, name, file, placeholder_key=None, placeholder_value="", **kwargs
):
    return Permissions(gen_auth(username, password, mfa_secret), org, name) \
        .team_permissions(
            file,
...
def _get_permissions(
    username, password, mfa_secret, org, profile, name, format, showindex=False, tablefmt="plain", **kwargs
):
