...
class ParserApis:
    ...
    def __init__(self, parser, **kwargs):
        self._parser = parser.add_parser('apis', help='apis').add_subparsers()
    ...
    def _build_apis_deploy_argument(self):
        apis_deploy = self._parser.add_parser('deploy', help='deploy apis', parents=[self._parent_parser(), self._dir_parser(), self._environment_parser()])
    ...
    def _build_export_api_proxy_argument(self):
        export_api_proxy = self._parser.add_parser('export', aliases=['export-api-proxy'], parents=[self._parent_parser()],
    ...
    def _build_get_api_proxy_argument(self):
        get_api_proxy = self._parser.add_parser('get', aliases=['get-api-proxy'], parents=[self._parent_parser()],
    ...
    def _build_list_api_proxies_argument(self):
        list_api_proxies = self._parser.add_parser('list', aliases=['list-api-proxies'], parents=[self._parent_parser(), self._prefix_parser()],
