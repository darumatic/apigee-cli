...
class ParserKeyvaluemaps:
    ...
    def _build_create_keyvaluemap_in_an_environment_argument(self):
        ...
        create_keyvaluemap_in_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).create_keyvaluemap_in_an_environment(args.environment, args.body).text))
    ...
    def _build_delete_keyvaluemap_from_an_environment_argument(self):
        ...
        delete_keyvaluemap_from_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).delete_keyvaluemap_from_an_environment(args.environment).text))
    ...
    def _build_delete_keyvaluemap_entry_in_an_environment_argument(self):
        ...
        delete_keyvaluemap_entry_in_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).delete_keyvaluemap_entry_in_an_environment(args.environment, args.entry_name).text))
    ...
    def _build_get_keyvaluemap_in_an_environment_argument(self):
        ...
        get_keyvaluemap_in_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).get_keyvaluemap_in_an_environment(args.environment).text))
    ...
    def _build_get_a_keys_value_in_an_environment_scoped_keyvaluemap_argument(self):
        ...
        get_a_keys_value_in_an_environment_scoped_keyvaluemap.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).get_a_keys_value_in_an_environment_scoped_keyvaluemap(args.environment, args.entry_name).text))
    ...
    def _build_list_keyvaluemaps_in_an_environment_argument(self):
        ...
        list_keyvaluemaps_in_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, None).list_keyvaluemaps_in_an_environment(args.environment, prefix=args.prefix)))
    ...
    def _build_update_keyvaluemap_in_an_environment_argument(self):
        ...
        update_keyvaluemap_in_an_environment.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).update_keyvaluemap_in_an_environment(args.environment, args.body).text))
    ...
    def _build_create_an_entry_in_an_environment_scoped_kvm_argument(self):
        ...
        create_an_entry_in_an_environment_scoped_kvm.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).create_an_entry_in_an_environment_scoped_kvm(args.environment, args.entry_name, args.entry_value).text))
    ...
    def _build_update_an_entry_in_an_environment_scoped_kvm_argument(self):
        ...
        update_an_entry_in_an_environment_scoped_kvm.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).update_an_entry_in_an_environment_scoped_kvm(args.environment, args.entry_name, args.updated_value).text))
    ...
    def _build_list_keys_in_an_environment_scoped_keyvaluemap_argument(self):
        ...
        list_keys_in_an_environment_scoped_keyvaluemap.set_defaults(func=lambda args: console.log(Keyvaluemaps(args, args.org, args.name).list_keys_in_an_environment_scoped_keyvaluemap(args.environment, args.startkey, args.count).text))
