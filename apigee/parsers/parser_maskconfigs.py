...
class ParserMaskconfigs:
    ...
    def _build_create_data_masks_for_an_api_proxy_argument(self):
        ...
        create_data_masks_for_an_api_proxy.set_defaults(func=lambda args: console.log(Maskconfigs(args, args.org, args.name).create_data_masks_for_an_api_proxy(args.body).text))
    ...
    def _build_delete_data_masks_for_an_api_proxy_argument(self):
        ...
        delete_data_masks_for_an_api_proxy.set_defaults(func=lambda args: console.log(Maskconfigs(args, args.org, args.name).delete_data_masks_for_an_api_proxy(args.maskconfig_name).text))
    ...
    def _build_get_data_mask_details_for_an_api_proxy_argument(self):
        ...
        get_data_mask_details_for_an_api_proxy.set_defaults(func=lambda args: console.log(Maskconfigs(args, args.org, args.name).get_data_mask_details_for_an_api_proxy(args.maskconfig_name).text))
    ...
    def _build_list_data_masks_for_an_api_proxy_argument(self):
        ...
        list_data_masks_for_an_api_proxy.set_defaults(func=lambda args: console.log(Maskconfigs(args, args.org, args.name).list_data_masks_for_an_api_proxy().text))
    ...
    def _build_list_data_masks_for_an_organization_argument(self):
        ...
        list_data_masks_for_an_organization.set_defaults(func=lambda args: console.log(Maskconfigs(args, args.org, None).list_data_masks_for_an_organization().text))
