...
class ParserUserroles:
    ...
    def _build_add_a_user_to_a_role_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).add_a_user_to_a_role(args.user_email).text))
    ...
    def _build_add_permissions_for_a_resource_to_a_user_role_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).add_permissions_for_a_resource_to_a_user_role(args.body).text))
    ...
    def _build_add_permissions_for_multiple_resources_to_a_user_role_argument(self):
        ...
        parser.add_argument('-b', '--body', help='request body', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).add_permissions_for_multiple_resources_to_a_user_role(args.body).text))
    ...
    def _build_create_a_user_role_in_an_organization_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).create_a_user_role_in_an_organization().text))
    ...
    def _build_delete_a_permission_for_a_resource_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).delete_a_permission_for_a_resource(args.permission, args.resource_path).text))
    ...
    def _build_delete_resource_from_permissions_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.add_argument('--resource-path', help='the resource path', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).delete_resource_from_permissions(args.resource_path).text))
    ...
    def _build_delete_a_user_role_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).delete_a_user_role().text))
    ...
    def _build_get_a_role_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).get_a_role().text))
    ...
    def _build_get_resource_permissions_for_a_specific_role_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).get_resource_permissions_for_a_specific_role(resource_path=args.resource_path).text))
    ...
    def _build_get_users_for_a_role_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).get_users_for_a_role().text))
    ...
    def _build_list_permissions_for_a_resource_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).list_permissions_for_a_resource().text))
    ...
    def _build_list_user_roles_argument(self):
        ...
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, None).list_user_roles().text))
    ...
    def _build_remove_user_membership_in_role_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.add_argument('--user-email', help='the email address of the user', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).remove_user_membership_in_role(args.user_email).text))
    ...
    def _build_verify_a_user_roles_permission_on_a_specific_RBAC_resource_argument(self):
        ...
        parser.add_argument('--permission', help='get, put, or delete', required=True)
        parser.add_argument('--resource-path', help='the resource path', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).verify_a_user_roles_permission_on_a_specific_RBAC_resource(args.permission, args.resource_path).text))
    ...
    def _build_verify_user_role_membership_argument(self):
        ...
        parser.add_argument('-n', '--name', help='the role name', required=True)
        parser.add_argument('--user-email', help='the email address of the user', required=True)
        parser.set_defaults(func=lambda args: console.log(Userroles(args, args.org, args.name).verify_user_role_membership(args.user_email).text))
