...
class ParserApps:
    ...
    def _build_create_developer_app_argument(self):
        ...
        create_developer_app.set_defaults(func=lambda args: console.log(Apps(args, args.org, None).create_developer_app(args.developer, args.body).text))
    ...
    def _build_delete_developer_app_arguments(self):
        ...
        delete_developer_app.set_defaults(func=lambda args: console.log(Apps(args, args.org, args.name).delete_developer_app(args.developer).text))
    ...
    def _build_create_empty_developer_app_argument(self):
        ...
        create_empty_developer_app.set_defaults(func=lambda args: console.log(Apps(args, args.org, args.name).create_empty_developer_app(args.developer, display_name=args.display_name, callback_url=args.callback_url).text))
    ...
    def _build_list_developer_apps_argument(self):
        ...
        list_developer_apps.set_defaults(func=lambda args: console.log(Apps(args, args.org, None).list_developer_apps(args.developer, prefix=args.prefix, expand=args.expand, count=args.count, startkey=args.startkey)))
    ...
    def _build_get_developer_app_details_argument(self):
        ...
        get_developer_app_details.set_defaults(func=lambda args: console.log(Apps(args, args.org, args.name).get_developer_app_details(args.developer).text))
    ...
    def _build_restore_app_argument(self):
        ...
        restore_app.set_defaults(func=lambda args: console.log(Apps(args, args.org, None).restore_app(args.file).text))
