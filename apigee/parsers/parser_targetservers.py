...
class ParserTargetservers:
    ...
    def _build_create_a_targetserver_argument(self):
        ...
        create_a_targetserver.set_defaults(func=lambda args: console.log(Targetservers(args, args.org, args.name).create_a_targetserver(args.environment, args.body).text))
    ...
    def _build_delete_a_targetserver_argument(self):
        ...
        delete_a_targetserver.set_defaults(func=lambda args: console.log(Targetservers(args, args.org, args.name).delete_a_targetserver(args.environment).text))
    ...
    def _build_list_targetservers_in_an_environment_argument(self):
        ...
        list_targetservers_in_an_environment.set_defaults(func=lambda args: console.log(Targetservers(args, args.org, None).list_targetservers_in_an_environment(args.environment, prefix=args.prefix)))
    ...
    def _build_get_targetserver_argument(self):
        ...
        get_targetserver.set_defaults(func=lambda args: console.log(Targetservers(args, args.org, args.name).get_targetserver(args.environment).text))
    ...
    def _build_update_a_targetserver_argument(self):
        ...
        update_a_targetserver.set_defaults(func=lambda args: console.log(Targetservers(args, args.org, args.name).update_a_targetserver(args.environment, args.body).text))
